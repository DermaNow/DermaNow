...
import static com.example.ala.dermanow.Constants.URL_ALL_VERIFIED_DOCTORS;

public class admin_verified_doctors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Verified Doctors");
        setContentView(R.layout.activity_admin_verified_doctors);
        doctorsList = (ListView) findViewById(R.id.verifiedlist);
        ...
        doctorsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(admin_verified_doctors.this, listview_item.class);
                ...
                intent.putExtra("status", "1"); // 1 for Unverified
    ...
    private void getAllDoctors() {
        ...
        // prepare the Request
        JsonObjectRequest getRequest = new JsonObjectRequest(Request.Method.GET, URL_ALL_VERIFIED_DOCTORS, null,
