...
public class Diagnosis_general_user extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diagnosis_general_user);
        setTitle("Diagnosis");
        //------------------------------------------------------------------------------------------

        disease_name = (TextView) findViewById(R.id.patientDiagnosis_diseaseName_text);
        description = (TextView) findViewById(R.id.general_descreption_fulltext);
        symptoms = (TextView) findViewById(R.id.general_symptoms_fulltext);
        precautions = (TextView) findViewById(R.id.general_precaution_fulltext);
        //------------------------------------------------------------------------------------------
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < result.length(); i++) {
                                JSONObject patient = result.getJSONObject(i);
