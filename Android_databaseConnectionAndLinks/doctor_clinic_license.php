...
$upload_path = 'doctor_clinic_license/';
...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    if(isset($_POST['name']) and isset($_FILES['pdf']['name'])){
        ...
        try{
            ...
            $sql = "INSERT INTO doctor_clinic_license (dr_id, url, name) VALUES ((SELECT dr_id from doctor WHERE username = '$name'), '$file_url', (SELECT name from doctor WHERE username = '$name'));";
